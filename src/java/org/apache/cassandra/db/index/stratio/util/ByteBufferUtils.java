...
public class ByteBufferUtils {
	 ...
	 * {@link org.apache.cassandra.utils.ByteBufferUtil.EMPTY_BYTE_BUFFER} if the {@code byteBuffer}
	 * is a composite. Otherwise, replaces {@code byteBuffer} by an empty
	...
	/**
	 * Returns the last {@link java.nio.ByteBuffer} of those contained in {@code byteBuffer} if it
	 * is a composite.
	 * 
	 * @param byteBuffer
	 ...
	 * @return the last {@link java.nio.ByteBuffer} of those contained in {@code byteBuffer} if it
	 *         is a composite.
	 */
	...
	/**
	 * Returns the {@link java.nio.ByteBuffer}s contained in {@code byteBuffer} according to
	 * {@code type}.
	 * 
	 * @param byteBuffer
	 ...
	 * @param type
	 *            the {@link AbstractType} of {@code byteBuffer}.
	 * @return the {@link java.nio.ByteBuffer}s contained in {@code byteBuffer} according to
	 *         {@code type}.
	 */
	...
	/**
	 * Returns the {@link java.nio.ByteBuffer} represented by {@code string}, which must be have
	 * generated by {@link #toString(ByteBuffer)}.
	 * 
	 * @param string
	 *            the {@link String} to be converted to {@link ByteBuffer}. This must be have
	 *            generated by {@link #toString(ByteBuffer)}.
