...
public class ClusteringKeyMapper
{
    ...
    /**
     * Returns the first possible column name of those having the same clustering key that the specified column name.
     * 
     * @param columnName
    ...
    /**
     * Returns the last possible column name of those having the same clustering key that the specified column name.
     * 
     * @param columnName
     *            A storage engine column name.
     * @return The first column name of for {@code columnName}.
    ...
    /**
     * Returns the first clustering key of the specified column family. There could be more than one.
     * 
     * @param columnFamily
    ...
    /**
     * Adds the to the specified {@link Document} the {@link Fields} representing the clustering key of the specified
     * storage engine {@link Column} name.
     * 
     * @param document
     *            A {@link Document}.
     * @param columnName
    ...
    /**
     * Returns a Lucene's {@link Filter} for filtering documents/rows according to the column name range specified in
     * {@code dataRange}.
     * 
     * @param dataRange
     *            The data range containing the column name range to be filtered.
     * @return A Lucene's {@link Filter} for filtering documents/rows according to the column name range specified in
     *         {@code dataRage}.
     */
    ...
    /**
     * Returns a Lucene's {@link Filter} for filtering documents/rows according to the column tombstone range specified
     * in {@code rangeTombstone}.
     * 
     * @param dataRange
     *            The data range containing the column tombstone range to be filtered.
     * @return A Lucene's {@link Filter} for filtering documents/rows according to the column tombstone range specified
     *         in {@code rangeTombstone}.
     */
    ...
    /**
     * Returns a Lucene's {@link SortField} array for sorting documents/rows according to the column family name.
     * 
     * @return A Lucene's {@link SortField} array for sorting documents/rows according to the column family name.
     */
