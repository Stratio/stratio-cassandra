...
public class GeoUtils {
     ...
     * @return levels need to achieve precision
     */
    public static int quadTreeLevelsForPrecision(GeoDistanceUnit distance) {
        return quadTreeLevelsForPrecision(distance.getMetres());
    }
     ...
     * @return levels need to achieve precision
     */
    public static int geoHashLevelsForPrecision(GeoDistanceUnit distance) {
        return geoHashLevelsForPrecision(distance.getMetres());
    }
