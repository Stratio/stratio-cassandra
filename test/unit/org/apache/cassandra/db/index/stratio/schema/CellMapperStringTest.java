...
public class CellMapperStringTest {
	...
	public void testValueNull() {
		...
		String parsed = mapper.value(null);
	...
	public void testValueFloatWithDecimalFloor() {
		CellMapperString mapper = new CellMapperString();
		String parsed = mapper.value(3.5f);
	...
	public void testValueFloatWithDecimalCeil() {
		CellMapperString mapper = new CellMapperString();
		String parsed = mapper.value(3.6f);
	...
	public void testValueDoubleWithDecimalFloor() {
		CellMapperString mapper = new CellMapperString();
		String parsed = mapper.value(3.5d);
		Assert.assertEquals("3.5", parsed);
	...
	public void testValueDoubleWithDecimalCeil() {
		CellMapperString mapper = new CellMapperString();
		String parsed = mapper.value(3.6d);
		Assert.assertEquals("3.6", parsed);
	...
	public void testValueStringWithDecimalFloor() {
		CellMapperString mapper = new CellMapperString();
		String parsed = mapper.value("3.2");
	...
	public void testValueStringWithDecimalCeil() {
		CellMapperString mapper = new CellMapperString();
		String parsed = mapper.value("3.6");
		Assert.assertEquals("3.6", parsed);
